...
namespace server
{
SpiderServer::SpiderServer(CommandCenter &cmdCenter, volatile bool const &running, std::uint32_t port) : m_controllers(), m_clients(), m_cmdCenter(cmdCenter), m_running(running), m_tcpSocket(port, 64, network::ASocket::SocketType::BLOCKING), m_commandQueue()
{
